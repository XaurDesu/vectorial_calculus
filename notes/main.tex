...
\begin{gather}
    ...
    \text{BUT THEN, that means a partial derivative for (0,0) does not exist, therefore this is not a continuous function.} \\
    \lim_{(x,y) \to (0,0)}  \frac{xy}{x^2+y^2} NE
\end{gather}

\section{Continual Functions}

A function can be defined as continual if:
