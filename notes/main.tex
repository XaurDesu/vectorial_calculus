...
\begin{equation}
    ...
    \end{pmatrix}
    \text{
        \textit{note: this can be generalized}}
\end{equation}
...
In general, most of the parts of linear algebra that concern us are those regarding
vectors. 
...
where $ \theta $ is the angle between both vectors.
